...
import type { PostAccountSignUpData, PostAccountSignUpError, PostAccountSignUpResponse, PostAccountLoginData, PostAccountLoginError, PostAccountLoginResponse, PostAccountLogoutError, PostAccountLogoutResponse, GetAccountCheckAuthError, GetAccountCheckAuthResponse, PostLobbyError, PostLobbyResponse, GetLobbyListData, GetLobbyListError, GetLobbyListResponse, GetLobbyActiveError, GetLobbyActiveResponse, GetLobbyStartError, GetLobbyStartResponse, GetLobbyConstantsError, GetLobbyConstantsResponse, GetProfileError, GetProfileResponse, PostProfileAddWizardData, PostProfileAddWizardError, PostProfileAddWizardResponse, GetProfileGetActiveLobbyStateError, GetProfileGetActiveLobbyStateResponse, PostProfileUpdateActiveLobbyByLobbyIdData, PostProfileUpdateActiveLobbyByLobbyIdError, PostProfileUpdateActiveLobbyByLobbyIdResponse } from './types.gen';
...
export const getLobbyStart = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetLobbyStartResponse, GetLobbyStartError, ThrowOnError>({
    ...options,
    url: '/Lobby/Start'
}); };

export const getLobbyConstants = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetLobbyConstantsResponse, GetLobbyConstantsError, ThrowOnError>({
    ...options,
    url: '/Lobby/Constants'
}); };
